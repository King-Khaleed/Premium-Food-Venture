...
export function Contact() {
  return (
    <section id="contact" className="relative w-full py-20 md:py-32 bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('https://picsum.photos/seed/contactbg/1920/1080')"}}>
